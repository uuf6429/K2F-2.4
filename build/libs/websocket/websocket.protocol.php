...
interface IWebSocketConnection {
	...
	public function metaSet($key, $val);
	public function metaIsset($key);
	public function metaUnset($key);
...
abstract class WebSocketConnection implements IWebSocketConnection {
	...
	public function metaGet($key, $def=null){
		return isset($this->_meta[$key]) ? $this->_meta[$key] : $def;
	}
...
class WebSocketConnectionHybi extends WebSocketConnection {
	...
	public function send($args){
		$this->sendString(@json_encode($args));
	}
